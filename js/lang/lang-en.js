...
TR['en'] = {
    ...
    // === LEVEL EDITOR (Phase 2-4) ===
    edBtnTest: 'TEST',
    edBtnSave: 'SAVE',
    edBtnPublish: 'PUBLISH',
    edBtnClear: 'CLEAR ALL',
    edBtnQuit: 'QUIT',
    edColor: 'COLOR',
    edHelp: 'Click = place | Right-click + drag = move view | Esc = quit',
    edTool_sol: 'GROUND',
    edTool_mur: 'SOLID WALL',
    edTool_murp: 'GHOST WALL',
    edTool_lave: 'LAVA',
    edTool_eau: 'WATER',
    edTool_tramp: 'BOUNCE',
    edTool_tele: 'PORTAL',
    edTool_porte: 'DOOR',
    edTool_bouton: 'BUTTON',
    edTool_checkpoint: 'CHECKPT.',
    edTool_spawn: 'START',
    edTool_arrivee: 'END',
    edTool_eraser: 'ERASE',
    edNeedSpawn: 'Place a START before testing',
    edNeedEnd: 'Place an END before testing',
    edNeedMore: 'Add more blocks (3 minimum)',
    edNoEngine: 'Engine unavailable',
    edSaved: 'Level saved',
    edSaveErr: 'Save error',
    edConfirmClear: 'Clear the entire level?',
    edCheckpoint: 'Checkpoint !',
    edButtonPressed: 'Button activated !',
    edPubTitle: 'PUBLISH YOUR LEVEL',
    edPubLabel: 'LEVEL TITLE (3-40 letters)',
    edPubPlaceholder: 'e.g.: The fortress',
    edPubWarn: '&#9888; Once published, your level will be <b>visible to all players</b> in the WORLDS section.<br>You can only publish a <b>new level every 14 days</b>.',
    edPubBtn: 'PUBLISH MY LEVEL',
    edTitleShort: 'Title too short (3 minimum)',
    edTitleLong: 'Title too long (40 maximum)',
    edPublishing: 'Publishing...',
    edPublished: 'Level published! Code: {0}',
    edPublishErr: 'Publish error',
    edRateLimit: 'Next publication in {0} days',
    edJoinByCode: 'JOIN BY CODE',
    edCodeLabel: 'LEVEL CODE (6 characters)',
    edJoinBtn: 'JOIN WORLD',
    edCodeInvalid: 'Invalid code (6 characters expected)',
    edCodeSearching: 'Searching...',
    edCodeNotFound: 'Code not found',
    edCodeError: 'Search error',
    salonMondesTitre: 'WORLDS CREATED BY PLAYERS',
    salonMondesEmpty: 'No world published yet. Be the first!',
    salonMondesLoading: 'Loading worlds...',
    salonMondesBy: 'By'
  };
