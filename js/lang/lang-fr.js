...
TR['fr'] = {
    ...
    // === EDITEUR DE NIVEAUX (Phase 2-4) ===
    edBtnTest: 'TESTER',
    edBtnSave: 'SAUVER',
    edBtnPublish: 'PUBLIER',
    edBtnClear: 'EFFACER TOUT',
    edBtnQuit: 'QUITTER',
    edColor: 'COULEUR',
    edHelp: 'Clic = placer | Clic-droit + glisser = deplacer la vue | Echap = quitter',
    edTool_sol: 'SOL',
    edTool_mur: 'MUR PLEIN',
    edTool_murp: 'MUR TRAV.',
    edTool_lave: 'LAVE',
    edTool_eau: 'EAU',
    edTool_tramp: 'RESSORT',
    edTool_tele: 'PORTAIL',
    edTool_porte: 'PORTE',
    edTool_bouton: 'BOUTON',
    edTool_checkpoint: 'CHECKPT.',
    edTool_spawn: 'DEPART',
    edTool_arrivee: 'ARRIVEE',
    edTool_eraser: 'EFFACER',
    edNeedSpawn: 'Place un DEPART avant de tester',
    edNeedEnd: 'Place une ARRIVEE avant de tester',
    edNeedMore: 'Ajoute plus de blocs (3 minimum)',
    edNoEngine: 'Moteur indisponible',
    edSaved: 'Niveau sauvegarde',
    edSaveErr: 'Erreur sauvegarde',
    edConfirmClear: 'Effacer tout le niveau ?',
    edCheckpoint: 'Checkpoint !',
    edButtonPressed: 'Bouton active !',
    edPubTitle: 'PUBLIER TON NIVEAU',
    edPubLabel: 'TITRE DU NIVEAU (3-40 lettres)',
    edPubPlaceholder: 'Ex: La forteresse',
    edPubWarn: '&#9888; Une fois publie, ton niveau sera <b>visible par tous les joueurs</b> dans la section MONDES du salon.<br>Tu ne pourras publier un <b>nouveau niveau que tous les 14 jours</b>.',
    edPubBtn: 'PUBLIER MON NIVEAU',
    edTitleShort: 'Titre trop court (3 minimum)',
    edTitleLong: 'Titre trop long (40 maximum)',
    edPublishing: 'Publication en cours...',
    edPublished: 'Niveau publie ! Code: {0}',
    edPublishErr: 'Erreur publication',
    edRateLimit: 'Prochaine publication dans {0} jours',
    edJoinByCode: 'REJOINDRE PAR CODE',
    edCodeLabel: 'CODE DU NIVEAU (6 caracteres)',
    edJoinBtn: 'JOINDRE LE MONDE',
    edCodeInvalid: 'Code invalide (6 caracteres attendus)',
    edCodeSearching: 'Recherche...',
    edCodeNotFound: 'Code introuvable',
    edCodeError: 'Erreur de recherche',
    salonMondesTitre: 'MONDES CREES PAR LES JOUEURS',
    salonMondesEmpty: 'Aucun monde publie pour l\'instant. Sois le premier !',
    salonMondesLoading: 'Chargement des mondes...',
    salonMondesBy: 'Par'
  };
